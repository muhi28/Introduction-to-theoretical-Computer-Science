...
/*  Sample 1.:
  ...
  ↳---> +---+ <-----a,b------  +---+   ---↲
        ...
        +---+ ---↲
☩*/
        Assert.assertEquals(nfa1.getSymbols(), Arrays.asList('a','b'));
        Assert.assertNotEquals(nfa1.getSymbols(), Arrays.asList('a','c'));
        Assert.assertNotEquals(nfa1.getSymbols(), Arrays.asList('d','b'));
        Assert.assertNotEquals(nfa1.getSymbols(), Arrays.asList('d','c'));

        Assert.assertEquals(nfa1.getAcceptingStates(), Arrays.asList(2));
        Assert.assertNotEquals(nfa1.getAcceptingStates(), Arrays.asList(0,2));
        Assert.assertNotEquals(nfa1.getAcceptingStates(), Arrays.asList(0,1));

        Assert.assertEquals(nfa1.getInitialState(), Arrays.asList(0));
        Assert.assertNotEquals(nfa1.getInitialState(), Arrays.asList(1));
        ...
        Assert.assertEquals(nfa1.getNextStates(2,"a"), Arrays.asList(2));
